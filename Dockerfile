...
RUN cd /code/php-src && git checkout PHP-7.1 && ./buildconf  && ./configure --disable-all --enable-debug --prefix=$HOME/myphp  CFLAGS="-g3 -gdwarf-4" && make && make install
